...
import com.org.jboss.loggingTools.exceptions.DateExceptionsBundle;
import com.org.jboss.loggingTools.loggers.DateLogger;
...
public class DateService {
    ...
    public int showDaysUntil(@PathParam("targetdate") String targetdate) {
        ...
        try {
            ...
            ParseException nex = DateExceptionsBundle.EXCEPTIONS.targetDateStringDidntParse(targetdate,
                    ex.getErrorOffset());
            ...
            throw new WebApplicationException(
                    Response.status(400).entity(nex.getLocalizedMessage()).type(MediaType.TEXT_PLAIN).build());
        }
